...
SWIFT_CLASS("_TtC5IMMap13NeighborFloor")
@interface NeighborFloor : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface NeighborFloor (SWIFT_EXTENSION(IMMap))
@property (nonatomic) int32_t floorId;
@property (nonatomic) int32_t floorNeighbourId;
@property (nonatomic) int32_t nodeId;
@property (nonatomic) int32_t nodeNeighbourId;
@property (nonatomic) int32_t typeOfStair;
@property (nonatomic) int32_t venueId;
@end


SWIFT_CLASS_NAMED("NeighborNode")
@interface NeighborNode : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface NeighborNode (SWIFT_EXTENSION(IMMap))
@property (nonatomic) float d;
@property (nonatomic) int32_t fid;
@property (nonatomic) int32_t nid;
@property (nonatomic) int32_t nnid;
@property (nonatomic) int32_t pid;
@property (nonatomic) int32_t vid;
@end
